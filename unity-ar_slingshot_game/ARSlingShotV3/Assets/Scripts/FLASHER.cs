...
public class FLASHER : MonoBehaviour //My blueprint
{
    public float ARPulser = 1.5f; //Rate at which the Betty Text pulses
    ...
    void Update() //updating every frameee
    {
        ...
        float scale = Mathf.Lerp(minScale, maxScale, Mathf.PingPong(Time.time * ARPulser, 1));
